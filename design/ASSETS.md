...
|---|---|---|---|---|---|
| `brand-mark` | Radiant emerald brain tile | full and compact | Generated PNG rendered in app UI | approved | Same master composition as the App Store icon for one recognizable identity; glossy emerald brain relief, ivory tile, and gold star remain legible at 60 px. Source: `design/assets/app-icon-generated-source.png`, web rendition: `public/brand-mark.png`. |
...
| `app-icon` | Radiant emerald brain tile | generated source plus 1024 px iOS rendition | Opaque PNG source + asset catalog | approved | No transparency, words, or language dependency; the brain silhouette survives 60 px; emerald, ivory, and gold match the in-game Brain tile. Source: `design/assets/app-icon-generated-source.png`; release fingerprint: `design/brand-assets.lock.json`. |
| `splash` | Centered radiant brain-tile brand mark | iPhone/iPad, lightless emerald | Deterministic PNG asset catalog | approved | Same mark as the icon/logo; no white flash or progress UI; safe at all aspect ratios. Generated by `scripts/render-brand-splash.py`; release fingerprint: `design/brand-assets.lock.json`. |
