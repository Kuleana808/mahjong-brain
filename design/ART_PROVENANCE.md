...
| `design/assets/app-icon-generated-source.png` and `ios/App/App/Assets.xcassets/AppIcon.appiconset/AppIcon-512@2x.png` | generated | OpenAI built-in image generation | 2026-08-14 | Edit of the first-party generated icon: replace only the face character with a bold brain emblem made from mirrored emerald lobes, mint circular pips, and a warm amber center seam. Preserve the glossy ivory tile, emerald sidewall, amber burst, bronze rim, fragments, leaves, composition, and crop. No competitor names or images were used. | Codex, visually checked at full size; 60 px regression is automated in the brand check |
